...
<div class="container">
    ...
    <div class="down">
        ...
        <a href="${pageContext.request.contextPath}/NoticeServlet?method=mainNotice" style="float: right">
...
<script type="text/javascript">
    ...
    function test() {
        ...
        if (content.length > 20000) {
            ...
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/NoticeServlet?method=addNotice",
                data: {"title": title, "beginTime": begin_date, "endTime": end_date, "content": content},
                dataType: "text",
